...
\restrict pWYzR2sWoI1UETbwSAq4L1WyFAT1dHbZyxgMeWyy245qzJxyDqWrgDxoz19CaFC
...
DROP POLICY IF EXISTS store_manager_orders ON retail.orders;
DROP POLICY IF EXISTS store_manager_order_items ON retail.order_items;
DROP POLICY IF EXISTS store_manager_inventory ON retail.inventory;
DROP POLICY IF EXISTS store_manager_customers ON retail.customers;
DROP POLICY IF EXISTS all_users_suppliers ON retail.suppliers;
DROP POLICY IF EXISTS all_users_supplier_performance ON retail.supplier_performance;
DROP POLICY IF EXISTS all_users_stores ON retail.stores;
DROP POLICY IF EXISTS all_users_products ON retail.products;
DROP POLICY IF EXISTS all_users_product_types ON retail.product_types;
DROP POLICY IF EXISTS all_users_product_image_embeddings ON retail.product_image_embeddings;
DROP POLICY IF EXISTS all_users_product_description_embeddings ON retail.product_description_embeddings;
DROP POLICY IF EXISTS all_users_procurement_requests ON retail.procurement_requests;
DROP POLICY IF EXISTS all_users_categories ON retail.categories;
ALTER TABLE IF EXISTS ONLY retail.supplier_performance DROP CONSTRAINT IF EXISTS supplier_performance_supplier_id_fkey;
ALTER TABLE IF EXISTS ONLY retail.supplier_contracts DROP CONSTRAINT IF EXISTS supplier_contracts_supplier_id_fkey;
ALTER TABLE IF EXISTS ONLY retail.products DROP CONSTRAINT IF EXISTS products_type_id_fkey;
ALTER TABLE IF EXISTS ONLY retail.products DROP CONSTRAINT IF EXISTS products_supplier_id_fkey;
ALTER TABLE IF EXISTS ONLY retail.products DROP CONSTRAINT IF EXISTS products_category_id_fkey;
ALTER TABLE IF EXISTS ONLY retail.product_types DROP CONSTRAINT IF EXISTS product_types_category_id_fkey;
ALTER TABLE IF EXISTS ONLY retail.product_image_embeddings DROP CONSTRAINT IF EXISTS product_image_embeddings_product_id_fkey;
ALTER TABLE IF EXISTS ONLY retail.product_description_embeddings DROP CONSTRAINT IF EXISTS product_description_embeddings_product_id_fkey;
ALTER TABLE IF EXISTS ONLY retail.procurement_requests DROP CONSTRAINT IF EXISTS procurement_requests_supplier_id_fkey;
ALTER TABLE IF EXISTS ONLY retail.procurement_requests DROP CONSTRAINT IF EXISTS procurement_requests_product_id_fkey;
ALTER TABLE IF EXISTS ONLY retail.orders DROP CONSTRAINT IF EXISTS orders_store_id_fkey;
ALTER TABLE IF EXISTS ONLY retail.orders DROP CONSTRAINT IF EXISTS orders_customer_id_fkey;
ALTER TABLE IF EXISTS ONLY retail.order_items DROP CONSTRAINT IF EXISTS order_items_store_id_fkey;
ALTER TABLE IF EXISTS ONLY retail.order_items DROP CONSTRAINT IF EXISTS order_items_product_id_fkey;
ALTER TABLE IF EXISTS ONLY retail.order_items DROP CONSTRAINT IF EXISTS order_items_order_id_fkey;
ALTER TABLE IF EXISTS ONLY retail.notifications DROP CONSTRAINT IF EXISTS notifications_request_id_fkey;
ALTER TABLE IF EXISTS ONLY retail.inventory DROP CONSTRAINT IF EXISTS inventory_store_id_fkey;
ALTER TABLE IF EXISTS ONLY retail.inventory DROP CONSTRAINT IF EXISTS inventory_product_id_fkey;
ALTER TABLE IF EXISTS ONLY retail.customers DROP CONSTRAINT IF EXISTS customers_primary_store_id_fkey;
DROP INDEX IF EXISTS retail.idx_suppliers_rating;
DROP INDEX IF EXISTS retail.idx_suppliers_preferred;
DROP INDEX IF EXISTS retail.idx_suppliers_name;
DROP INDEX IF EXISTS retail.idx_suppliers_esg;
DROP INDEX IF EXISTS retail.idx_suppliers_code;
DROP INDEX IF EXISTS retail.idx_suppliers_approved;
DROP INDEX IF EXISTS retail.idx_suppliers_active;
DROP INDEX IF EXISTS retail.idx_supplier_performance_supplier;
DROP INDEX IF EXISTS retail.idx_supplier_performance_overall;
DROP INDEX IF EXISTS retail.idx_supplier_performance_date;
DROP INDEX IF EXISTS retail.idx_supplier_contracts_supplier;
DROP INDEX IF EXISTS retail.idx_supplier_contracts_status;
DROP INDEX IF EXISTS retail.idx_stores_name;
DROP INDEX IF EXISTS retail.idx_products_type;
DROP INDEX IF EXISTS retail.idx_products_supplier;
DROP INDEX IF EXISTS retail.idx_products_sku_covering;
DROP INDEX IF EXISTS retail.idx_products_sku;
DROP INDEX IF EXISTS retail.idx_products_price;
DROP INDEX IF EXISTS retail.idx_products_margin;
DROP INDEX IF EXISTS retail.idx_products_lead_time;
DROP INDEX IF EXISTS retail.idx_products_discontinued;
DROP INDEX IF EXISTS retail.idx_products_covering;
DROP INDEX IF EXISTS retail.idx_products_cost;
DROP INDEX IF EXISTS retail.idx_products_category;
DROP INDEX IF EXISTS retail.idx_product_types_name;
DROP INDEX IF EXISTS retail.idx_product_types_category;
DROP INDEX IF EXISTS retail.idx_product_image_embeddings_vector;
DROP INDEX IF EXISTS retail.idx_product_image_embeddings_url;
DROP INDEX IF EXISTS retail.idx_product_image_embeddings_product;
DROP INDEX IF EXISTS retail.idx_product_description_embeddings_vector;
DROP INDEX IF EXISTS retail.idx_procurement_requests_urgency;
DROP INDEX IF EXISTS retail.idx_procurement_requests_supplier;
DROP INDEX IF EXISTS retail.idx_procurement_requests_status;
DROP INDEX IF EXISTS retail.idx_procurement_requests_requester;
DROP INDEX IF EXISTS retail.idx_procurement_requests_product;
DROP INDEX IF EXISTS retail.idx_procurement_requests_number;
DROP INDEX IF EXISTS retail.idx_procurement_requests_department;
DROP INDEX IF EXISTS retail.idx_procurement_requests_date;
DROP INDEX IF EXISTS retail.idx_orders_store_date;
DROP INDEX IF EXISTS retail.idx_orders_store;
DROP INDEX IF EXISTS retail.idx_orders_date;
DROP INDEX IF EXISTS retail.idx_orders_customer_date;
DROP INDEX IF EXISTS retail.idx_orders_customer;
DROP INDEX IF EXISTS retail.idx_order_items_total;
DROP INDEX IF EXISTS retail.idx_order_items_store;
DROP INDEX IF EXISTS retail.idx_order_items_product;
DROP INDEX IF EXISTS retail.idx_order_items_order;
DROP INDEX IF EXISTS retail.idx_order_items_covering;
DROP INDEX IF EXISTS retail.idx_notifications_type;
DROP INDEX IF EXISTS retail.idx_notifications_request;
DROP INDEX IF EXISTS retail.idx_inventory_store_product;
DROP INDEX IF EXISTS retail.idx_inventory_store;
DROP INDEX IF EXISTS retail.idx_inventory_product;
DROP INDEX IF EXISTS retail.idx_customers_primary_store;
DROP INDEX IF EXISTS retail.idx_customers_email;
DROP INDEX IF EXISTS retail.idx_company_policies_type;
DROP INDEX IF EXISTS retail.idx_company_policies_threshold;
DROP INDEX IF EXISTS retail.idx_categories_name;
DROP INDEX IF EXISTS retail.idx_approvers_limit;
DROP INDEX IF EXISTS retail.idx_approvers_department;
ALTER TABLE IF EXISTS ONLY retail.suppliers DROP CONSTRAINT IF EXISTS suppliers_supplier_code_key;
ALTER TABLE IF EXISTS ONLY retail.suppliers DROP CONSTRAINT IF EXISTS suppliers_pkey;
ALTER TABLE IF EXISTS ONLY retail.supplier_performance DROP CONSTRAINT IF EXISTS supplier_performance_pkey;
ALTER TABLE IF EXISTS ONLY retail.supplier_contracts DROP CONSTRAINT IF EXISTS supplier_contracts_pkey;
ALTER TABLE IF EXISTS ONLY retail.supplier_contracts DROP CONSTRAINT IF EXISTS supplier_contracts_contract_number_key;
ALTER TABLE IF EXISTS ONLY retail.stores DROP CONSTRAINT IF EXISTS stores_store_name_key;
ALTER TABLE IF EXISTS ONLY retail.stores DROP CONSTRAINT IF EXISTS stores_pkey;
ALTER TABLE IF EXISTS ONLY retail.products DROP CONSTRAINT IF EXISTS products_sku_key;
ALTER TABLE IF EXISTS ONLY retail.products DROP CONSTRAINT IF EXISTS products_pkey;
ALTER TABLE IF EXISTS ONLY retail.product_types DROP CONSTRAINT IF EXISTS product_types_pkey;
ALTER TABLE IF EXISTS ONLY retail.product_image_embeddings DROP CONSTRAINT IF EXISTS product_image_embeddings_pkey;
ALTER TABLE IF EXISTS ONLY retail.product_description_embeddings DROP CONSTRAINT IF EXISTS product_description_embeddings_pkey;
ALTER TABLE IF EXISTS ONLY retail.procurement_requests DROP CONSTRAINT IF EXISTS procurement_requests_request_number_key;
ALTER TABLE IF EXISTS ONLY retail.procurement_requests DROP CONSTRAINT IF EXISTS procurement_requests_pkey;
ALTER TABLE IF EXISTS ONLY retail.orders DROP CONSTRAINT IF EXISTS orders_pkey;
ALTER TABLE IF EXISTS ONLY retail.order_items DROP CONSTRAINT IF EXISTS order_items_pkey;
ALTER TABLE IF EXISTS ONLY retail.notifications DROP CONSTRAINT IF EXISTS notifications_pkey;
ALTER TABLE IF EXISTS ONLY retail.inventory DROP CONSTRAINT IF EXISTS inventory_pkey;
ALTER TABLE IF EXISTS ONLY retail.customers DROP CONSTRAINT IF EXISTS customers_pkey;
ALTER TABLE IF EXISTS ONLY retail.customers DROP CONSTRAINT IF EXISTS customers_email_key;
ALTER TABLE IF EXISTS ONLY retail.company_policies DROP CONSTRAINT IF EXISTS company_policies_pkey;
ALTER TABLE IF EXISTS ONLY retail.categories DROP CONSTRAINT IF EXISTS categories_pkey;
ALTER TABLE IF EXISTS ONLY retail.categories DROP CONSTRAINT IF EXISTS categories_category_name_key;
ALTER TABLE IF EXISTS ONLY retail.approvers DROP CONSTRAINT IF EXISTS approvers_pkey;
ALTER TABLE IF EXISTS ONLY retail.approvers DROP CONSTRAINT IF EXISTS approvers_employee_id_key;
ALTER TABLE IF EXISTS retail.suppliers ALTER COLUMN supplier_id DROP DEFAULT;
ALTER TABLE IF EXISTS retail.supplier_performance ALTER COLUMN performance_id DROP DEFAULT;
ALTER TABLE IF EXISTS retail.supplier_contracts ALTER COLUMN contract_id DROP DEFAULT;
ALTER TABLE IF EXISTS retail.stores ALTER COLUMN store_id DROP DEFAULT;
ALTER TABLE IF EXISTS retail.products ALTER COLUMN product_id DROP DEFAULT;
ALTER TABLE IF EXISTS retail.product_types ALTER COLUMN type_id DROP DEFAULT;
ALTER TABLE IF EXISTS retail.procurement_requests ALTER COLUMN request_id DROP DEFAULT;
ALTER TABLE IF EXISTS retail.orders ALTER COLUMN order_id DROP DEFAULT;
ALTER TABLE IF EXISTS retail.order_items ALTER COLUMN order_item_id DROP DEFAULT;
ALTER TABLE IF EXISTS retail.notifications ALTER COLUMN notification_id DROP DEFAULT;
ALTER TABLE IF EXISTS retail.customers ALTER COLUMN customer_id DROP DEFAULT;
ALTER TABLE IF EXISTS retail.company_policies ALTER COLUMN policy_id DROP DEFAULT;
ALTER TABLE IF EXISTS retail.categories ALTER COLUMN category_id DROP DEFAULT;
ALTER TABLE IF EXISTS retail.approvers ALTER COLUMN approver_id DROP DEFAULT;
DROP SEQUENCE IF EXISTS retail.suppliers_supplier_id_seq;
DROP TABLE IF EXISTS retail.suppliers;
DROP SEQUENCE IF EXISTS retail.supplier_performance_performance_id_seq;
DROP TABLE IF EXISTS retail.supplier_performance;
DROP SEQUENCE IF EXISTS retail.supplier_contracts_contract_id_seq;
DROP TABLE IF EXISTS retail.supplier_contracts;
DROP SEQUENCE IF EXISTS retail.stores_store_id_seq;
DROP TABLE IF EXISTS retail.stores;
DROP SEQUENCE IF EXISTS retail.products_product_id_seq;
DROP TABLE IF EXISTS retail.products;
DROP SEQUENCE IF EXISTS retail.product_types_type_id_seq;
DROP TABLE IF EXISTS retail.product_types;
DROP TABLE IF EXISTS retail.product_image_embeddings;
DROP TABLE IF EXISTS retail.product_description_embeddings;
DROP SEQUENCE IF EXISTS retail.procurement_requests_request_id_seq;
DROP TABLE IF EXISTS retail.procurement_requests;
DROP SEQUENCE IF EXISTS retail.orders_order_id_seq;
DROP TABLE IF EXISTS retail.orders;
DROP SEQUENCE IF EXISTS retail.order_items_order_item_id_seq;
DROP TABLE IF EXISTS retail.order_items;
DROP SEQUENCE IF EXISTS retail.notifications_notification_id_seq;
DROP TABLE IF EXISTS retail.notifications;
DROP TABLE IF EXISTS retail.inventory;
DROP SEQUENCE IF EXISTS retail.customers_customer_id_seq;
DROP TABLE IF EXISTS retail.customers;
DROP SEQUENCE IF EXISTS retail.company_policies_policy_id_seq;
DROP TABLE IF EXISTS retail.company_policies;
DROP SEQUENCE IF EXISTS retail.categories_category_id_seq;
DROP TABLE IF EXISTS retail.categories;
DROP SEQUENCE IF EXISTS retail.approvers_approver_id_seq;
DROP TABLE IF EXISTS retail.approvers;
...
\unrestrict pWYzR2sWoI1UETbwSAq4L1WyFAT1dHbZyxgMeWyy245qzJxyDqWrgDxoz19CaFC
